...
public class FareCalculatorServiceTest {
	...
	@Nested
	@Tag("Tests_pour_le_type_Voiture")
	class TestCar {
		...
		public void calculateFareCar() {
			...
			// GIVEN
			LocalDateTime inTime = LocalDateTime.now().minusMinutes(60);// inTime.setTime( System.currentTimeMillis() -
																		// ( 60 * 60 * 1000) );
		...
		public void calculateFareCarWithFutureInTime() {
			LocalDateTime inTime = LocalDateTime.now().plusHours(1);// inTime.setTime( System.currentTimeMillis() + ( 60
																	// * 60 * 1000) );
			LocalDateTime outTime = LocalDateTime.now();
			ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
		...
		public void calculateFareCarWithLessThanOneHourParkingTime() {
			...
			LocalDateTime inTime = LocalDateTime.now().minusMinutes(45);// 45 minutes parking time should give 3/4th
																		// parking fare
			LocalDateTime outTime = LocalDateTime.now();// inTime.setTime( System.currentTimeMillis() - ( 45 * 60 *
														// 1000) );
			ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
			ticket.setInTime(inTime);
			ticket.setOutTime(outTime);
		...
		public void calculateFareCarWithMoreThanADayParkingTime() {
			...
			LocalDateTime inTime = LocalDateTime.now().minusHours(24);// 24 hours parking time should give 24 * parking
																		// fare per hour
			LocalDateTime outTime = LocalDateTime.now(); // inTime.setTime( System.currentTimeMillis() - ( 24 * 60 * 60
															// * 1000) );
			ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
		...
		public void calculateFareCar_WithLessThan30MinutesParkingTime_shouldCost0Dollars() {
			...
			LocalDateTime outTime = LocalDateTime.now();// inTime.setTime( System.currentTimeMillis() - ( 30 * 60 *
														// 1000) );
			ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
		...
		public void calculateFareCar_WhenTheUserIsRecurring_TheneReduction() {
			...
			LocalDateTime inTime = LocalDateTime.now().minusMinutes(60);//// 60 minutes parking time should give 1.425
																		//// dollars
			LocalDateTime outTime = LocalDateTime.now(); // inTime.setTime( System.currentTimeMillis() - ( 60 * 60 *
															// 1000) );
			ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
	...
	class TestBike {
		...
		public void calculateFareBike() {
			...
			// GIVEN
			LocalDateTime inTime = LocalDateTime.now().minusHours(1);// inTime.setTime( System.currentTimeMillis() - (
																		// 60 * 60 * 1000) );
			LocalDateTime outTime = LocalDateTime.now();
		...
		public void calculateFareBikeWithLessThanOneHourParkingTime() {
			// GIVEN
			LocalDateTime inTime = LocalDateTime.now().minusMinutes(45);// inTime.setTime( System.currentTimeMillis() -
																		// ( 45 * 60 * 1000) );
